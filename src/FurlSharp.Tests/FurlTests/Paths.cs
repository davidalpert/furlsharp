...
namespace FurlSharp.Tests.FurlTests
{
    ...
    public class Paths
    {
        ...
        {
            var f = FurlSharp.Furl.Parse("http://www.google.com/a/larg%20ish/path");
        ...
        {
            var f = new FurlSharp.Furl("/url/path");
        ...
        {
            var f = new FurlSharp.Furl("http://www.google.com/#/absolute/fragment/path/");
        ...
        {
            var f = new FurlSharp.Furl("http://www.google.com////a/./b/lolsup/../c/");
