...
namespace FurlSharp.Tests.FurlTests
{
    ...
    public class Query
    {
        ...
        {
            var f = new FurlSharp.Furl("http://www.google.com/?one=1&two=2");
        ...
        {
            var f = new FurlSharp.Furl("http://www.google.com/?on%20e=1%202&two=2");
        ...
        public void
            ...
            ()
        {
            var f = new FurlSharp.Furl("http://google.com/");
        ...
        {
            var f = new FurlSharp.Furl("http://www.google.com/?space=jams&space=slams");
